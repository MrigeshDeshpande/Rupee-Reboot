...
function LandingPage() {
  ...
  <div className="hero-content">
    <div className="hero-text">
      <h1>
        Simplify <span className="highlight">Adulting</span> with Your Finances
      </h1>
    ...
    <div className="cards">
        ...
        <p>Play with different scenarios to see what could change tomorrow.</p>
        </div>
        <div className="card">
      ...
      <footer className="footer">
        <p>© 2025 <span className="footer-brand">RupeeReboot</span>. All rights reserved.</p>
      </footer>
    </div>
  );
}
