  ...
  return (
    <div className="auth-page">
      <div className="auth-container">
        ...
        <p className="auth-subtitle">Review your details before we simulate your finances.</p>
        ...
        <div className="summary-section">
          ...
          <ul>
            {Object.entries(formData.fixedExpenses || {}).map(([key, value]) => (
          ...
          <ul>
            {Object.entries(formData.variableExpenses || {}).map(([key, value]) => (
              <li key={key}>{key}: ₹ {value}</li>
            ))}
          </ul>
        ...
        <div className="auth-btn-group spaced-buttons">
          ...
          <button type="button" className="auth-btn">Simulate</button>
        </div>
      </div>
    </div>
  );
